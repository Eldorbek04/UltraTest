...
@section('content')
    ...
    <main class="content">
        ...
        <header class="header" style="margin-bottom: 40px;">
            <div>
                <h1 style="font-size: 1.8rem; font-weight: 700;">FAQ Boshqaruvi</h1>
                <p style="color: #6c7293; margin-top: 5px;">FAQ umumiy boshqaruv paneli.</p>
            </div>
            <a href="{{ route("admin.faq.create") }}" class="btn-add"
                ...
                <i class="fas fa-plus-circle"></i> Yangi FAQ
            </a>
        </header>
                    ...
                    @foreach ($faq->reverse() as $item)
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a href="{{ route('admin.faq.edit', $item->id) }}" class="btn-icon btn-edit"
                                    title="Tahrirlash">
                                    <i class="fas fa-pen-nib"></i>
                                </a>

                                <form style="display: inline" action="{{ route('admin.faq.destroy', $item->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
